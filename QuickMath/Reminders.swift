...
enum Reminders {
    private static let identifier = "stoa.daily.reminder"
    ...
    static func schedule(hour: Int, minute: Int) {
        ...
        content.title = "Today's Stoa reflection is ready"
        content.body = "A moment of Stoic calm each day. Keep your streak alive."
